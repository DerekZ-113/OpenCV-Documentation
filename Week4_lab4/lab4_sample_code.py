...
image = cv2.imread('../images/mountain1.png')
...
image1 = cv2.imread('../images/mountain1.png', cv2.IMREAD_GRAYSCALE)
image2 = cv2.imread('../images/mountain2.png', cv2.IMREAD_GRAYSCALE)
